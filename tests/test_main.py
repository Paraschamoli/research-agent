...
from research_agent.main import handler
...
async def test_handler_returns_response():
    ...
    with patch("research_agent.main._initialized", True), \
...
async def test_handler_initialization():
    ...
    with patch("research_agent.main._initialized", False), \
         patch("research_agent.main.initialize_all", new_callable=AsyncMock) as mock_init, \
         patch("research_agent.main.run_agent", new_callable=AsyncMock, return_value=mock_response), \
